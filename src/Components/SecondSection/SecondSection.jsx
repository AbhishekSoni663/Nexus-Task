  ...
  return (
    <>
      <section className="second-section">
        <div className="second-sec-head">
          <div className="second-sec-h2">
            <svg
