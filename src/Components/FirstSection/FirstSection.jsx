      ...
      <div className="fourth-container">
        <div className="fourth-head">
          <div className="fourth-detail">
            <span className="fourth-head-h2">
              <svg
                aria-labelledby="aesop-15664"
            ...
            <span className="fourth-detail-head">
              <h6 className="fourth-detail-h6">Doorways to the undiscoverd</h6>
              <p className="fourth-detail-p">
                Othertopias: a collection of <br /> unorthodox fragrances
              </p>
              <p className="fourth-detail-p1">
                Step inside six fragrant worlds that transcend our <br />
                immediate perception—vivid and distinctive.
              </p>
              <button className="fourth-sec-btn">
                Discover the fragrance <i className="bi bi-arrow-right"></i>
              </button>
            </span>
          </div>
        </div>
